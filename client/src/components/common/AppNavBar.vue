  ...
  <nav class="navbar">
    <div class="navbar-inner">
      ...
      <div class="navbar-actions">
        <button class="theme-toggle" :title="ui.isDark ? 'Switch to light mode' : 'Switch to dark mode'" :aria-label="ui.isDark ? 'Switch to light mode' : 'Switch to dark mode'" @click="ui.toggleTheme">
          <svg v-if="ui.isDark" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="5"/><line x1="12" y1="1" x2="12" y2="3"/><line x1="12" y1="21" x2="12" y2="23"/><line x1="4.22" y1="4.22" x2="5.64" y2="5.64"/><line x1="18.36" y1="18.36" x2="19.78" y2="19.78"/><line x1="1" y1="12" x2="3" y2="12"/><line x1="21" y1="12" x2="23" y2="12"/><line x1="4.22" y1="19.78" x2="5.64" y2="18.36"/><line x1="18.36" y1="5.64" x2="19.78" y2="4.22"/></svg>
          <svg v-else width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"/></svg>
        </button>
        <template v-if="auth.isAuthenticated">
          <router-link v-if="auth.isMerchant" to="/merchant" class="btn btn-ghost btn-sm merchant-link">Merchant Hub</router-link>
...
.theme-toggle { width: 32px; height: 32px; border-radius: 50%; border: none; background: transparent; color: var(--color-text-secondary); cursor: pointer; display: flex; align-items: center; justify-content: center; transition: all var(--transition-fast); }
.theme-toggle:hover { background: var(--color-bg-secondary); color: var(--color-text); }
.merchant-link { color: var(--color-accent); border-color: var(--color-accent); }
