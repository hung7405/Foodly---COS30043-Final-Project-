      ...
      <transition name="fade">
        <div v-if="result" class="result-card">
          <div class="result-header">
            ...
            <div class="confidence-badge">{{ (result.confidence * 100).toFixed(0) }}% confidence</div>
          </div>
          ...
          <div v-if="result.matches?.length" class="matches-section">
            ...
            <router-link v-for="deal in result.matches" :key="deal.id" :to="'/deals/' + deal.id" class="match-row">
              <div class="match-thumb">
                <img
                  :src="deal.images?.[0] || 'https://images.unsplash.com/photo-1586999768265-24af89630739?w=100&q=80'"
                  :alt="deal.title"
                  loading="lazy"
                />
              </div>
          ...
          <div class="result-actions">
            <router-link
              :to="'/explore?search=' + encodeURIComponent(result.matchedKeywords?.[0] || '')"
